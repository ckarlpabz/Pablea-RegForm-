...
<body>
	<center><table border="8">
		<form action="step 5.php" method="GET">
			<h1>Student Registration Form (Step 4 of 6)</h1>
			<tr>
			...
			<tr>
				<td colspan="3">
					<pre><center><a href="step 3.php">Back</a>		<input type="submit" id="ck" value="Next Step"></center></pre>
				</td>
			</tr>
		</form>
	</table>
