...
<body>
	<center><table border="8">
		<form action="registration.php" method="POST">
			...
			<tr>
				<td colspan="3">
					<pre><center><a href="step 5.php">Back</a>		<input type="submit"  name="submit" value="Submit Registration" id="ck">  	 <input type="reset" name="reset"  value="Reset" id="ck"></center></p>
				</td>
			</tr>
		</form>
	</table>
